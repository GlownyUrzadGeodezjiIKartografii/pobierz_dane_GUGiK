...
class PobieranieEGIB:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&Pobierz dane GUGiK')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('PobieranieGUGiK', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/pobierz_dane_GUGiK/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Pobierz dane GUGiK'),
            callback=self.run,
