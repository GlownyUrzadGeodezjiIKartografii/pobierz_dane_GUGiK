...
class WFSClient:
    def __init__(self, url="https://mapy.geoportal.gov.pl/wss/service/PZGIK/EGIB/WFS/UslugaZbiorcza"):
        self.url = url
        self.ns = {
...
<wfs:GetFeature service="WFS" version="2.0.0" 
    ...
    <wfs:Query typeNames="ms:dzialki" srsName="EPSG:2180">
    ...
    def build_id_filter(self, ids):
        ...
        for identifier in ids:
            ...
            if '*' in identifier or '?' in identifier:
                 conditions.append(f'<fes:PropertyIsLike wildCard="*" singleChar="?" escape="\\"><fes:ValueReference>id_dzialki</fes:ValueReference><fes:Literal>{identifier}</fes:Literal></fes:PropertyIsLike>')
            else:
                conditions.append(f'<fes:PropertyIsEqualTo><fes:ValueReference>id_dzialki</fes:ValueReference><fes:Literal>{identifier}</fes:Literal></fes:PropertyIsEqualTo>')
